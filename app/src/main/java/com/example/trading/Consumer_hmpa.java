...
public class Consumer_hmpa extends AppCompatActivity {
    String consumer_id;
    String user_id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_consumer_hmpa);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String rsp) {
                        try {
                            ...
                            con_id = rsp_json.getString("con_id");
                            con_name = rsp_json.getString("con_name");
                            con_sname = rsp_json.getString("con_sname");
                            ...
                            if(status.equals("OK"))
                            {
                                ...
                                ((EditText)findViewById(R.id.editText3)).setText(con_name);
                                ((EditText)findViewById(R.id.editText4)).setText(con_sname);
    ...
    public void saveToDatabase(){
        ...
        String r_file = "con_changeProfile.php";
        String r_url = "?con_id="+consumer_id+"&con_name="+((EditText)findViewById(R.id.editText3)).getText().toString()
                      +"&con_sname="+((EditText)findViewById(R.id.editText4)).getText().toString();
        String mainUrl = "http://halted-refrigerator.000webhostapp.com/medical/";
        RequestQueue queue = Volley.newRequestQueue(Consumer_hmpa.this);
    ...
    View.OnClickListener changePass = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(Consumer_hmpa.this, ChangePassword.class);
    ...
    View.OnClickListener search_items = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(Consumer_hmpa.this, Search_page.class);
    ...
    View.OnClickListener go_chats = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(Consumer_hmpa.this, Chats.class);
            intent.putExtra("user_id",user_id);
            startActivity(intent);
        }
    };
